...
const enquirySchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['new', 'in_progress', 'follow_up', 'converted', 'closed', 'rejected'],
    default: 'new'
  },
  rejectedAt: {
    type: Date
...
enquirySchema.pre('save', function (next) {
  ...
  // Set rejectedAt if status changed to rejected
...
// TTL Index for auto-deletion of rejected enquiries after 1 day (86400 seconds)
enquirySchema.index({ rejectedAt: 1 }, { expireAfterSeconds: 86400 });
